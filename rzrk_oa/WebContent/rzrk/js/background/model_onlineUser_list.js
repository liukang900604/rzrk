...
function renderContent(value, rowData, index){
	var a = "<a href='#' class='showContent' content='{0}'>查看</a>";        
...
//            {title: "", field: "isChecked", width: 180, align: 'center', checkbox:true},
            {title: "用户", field: "user", width: 200, align: 'center', sortable: true},
            {title: "代理IP", field: "proxyip", width: 130, align: 'center', sortable: true},
            {title: "客户端IP", field: "clientip", width: 150, align: 'center', sortable: true},
            {title: "客户端端口号", field: "clientport", width: 130, align: 'center', sortable: true},
            {title: "登陆时间", field: "datetime", width: 150, align: 'center', sortable: true},
        ]];
    return columns;
}
...
function getConfig(){
    return {
        loadMsg: '正在获取数据......',
        url: '/admin/model!getAjaxOnlineList.action',
        method: 'get',
        width: '100%',
        rownumbers: true,
