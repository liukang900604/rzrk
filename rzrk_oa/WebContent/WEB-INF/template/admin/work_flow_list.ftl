...
<head lang="en">
    ...
    <script type="text/javascript" src="/rzrk/js/background/workFlow_list.js"></script>
...
<body>
	<div class="searchBar">
		<a id="addWorkFlow" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'">新增流程</a>
		&nbsp;&nbsp;&nbsp;&nbsp;
