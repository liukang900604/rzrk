...
<head lang="en">
    ...
    <script type="text/javascript" src="/rzrk/js/background/log_list.js"></script>
</head>
<body>
	<div class="searchBar">
		<a id="delLogs" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-remove'">批量删除</a>
		&nbsp;&nbsp;&nbsp;&nbsp;
		<label for="searchBy">查询：</label>
		<select id="searchBy" class="easyui-combobox" name="searchBy" style="width:80px;">
			<option value="operation">操作名称</option>
