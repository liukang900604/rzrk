...
<head lang="en">
    ...
    <script type="text/javascript" src="/rzrk/js/background/group_list.js"></script>
</head>
<body>
	<div class="searchBar">
		<a id="addGroup" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'">添加部门</a>
		<a id="delGroups" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-remove'">批量删除</a>
		&nbsp;&nbsp;&nbsp;&nbsp;
