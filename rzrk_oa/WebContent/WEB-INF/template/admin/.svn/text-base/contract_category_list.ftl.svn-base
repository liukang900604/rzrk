...
<head lang="en">
    ...
    <script type="text/javascript" src="/rzrk/js/background/contract_category_list.js"></script>
</head>
<body>
	<div class="searchBar">
		<a id="addContractCategory" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'">添加二级分类</a>
		<#if superRole==true >
