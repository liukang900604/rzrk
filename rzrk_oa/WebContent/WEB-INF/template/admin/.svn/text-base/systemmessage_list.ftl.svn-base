...
<head lang="en">
    ...
    <script type="text/javascript" src="/rzrk/js/background/systemmessage__list.js"></script> 
</head>
<body>
	<div class="searchBar">
		<a id="addSystemmessage"  href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'">发布信息</a>
		<a id="selectSystemmessage"  href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'">已发消息</a>
		<a id="delSystemmessage" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-remove'">批量删除</a>
	</div>
