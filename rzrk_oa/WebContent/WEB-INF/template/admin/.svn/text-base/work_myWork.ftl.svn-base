...
<head lang="en">
    ...
    <script type="text/javascript" src="/rzrk/js/background/work_flow_myWork.js"></script>
</head>
<body>
	<div class="searchBar">
		<div class="row">
			<label for="flow">所属流程：</label>
			<select id="flow" name="flow" style="width:150px;">
			...
			<input id="beginDate" name="beginDate" type="text" style="width:120px;">
			&nbsp;至&nbsp;
			<input id="endDate" name="endDate" type="text" style="width:120px;">
			&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<div class="row tags">
			<a href="javascript:" tag="0" class="selected" onclick="preHandleWork();">待办工作</a>|
			<a href="javascript:" tag="1" onclick="handleWork();">已完成工作</a>|
			<a href="javascript:" tag="2" onclick="checkWork();">已审批工作</a>
		</div>
		<#--
