...
<head lang="en">
    ...
    <script type="text/javascript" src="/rzrk/js/background/work_flow_workCheck.js"></script>
</head>
<body>
<div class="searchBar">
		<div class="row">
			<label for="flow">所属流程：</label>
			<select id="flow" name="flow" style="width:80px;">
			...
			<input id="beginDate" name="beginDate" type="text" class="easyui-datebox" data-options="formatter: dateFormatter, parser: dateParser, editable:true" style="width:120px;">
			&nbsp;至&nbsp;
			<input id="endDate" name="endDate" type="text" class="easyui-datebox" data-options="formatter: dateFormatter, parser: dateParser, editable:true" style="width:120px;">
			&nbsp;&nbsp;&nbsp;&nbsp;
