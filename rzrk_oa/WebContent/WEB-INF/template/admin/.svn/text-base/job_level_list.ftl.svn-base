...
<head lang="en">
    ...
    <script type="text/javascript" src="/rzrk/js/background/joblevel_list.js"></script>
</head>
<body>
	<div class="searchBar">
		<a id="addJobLevel" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'">添加职务级别</a>
		...
		<select id="searchBy" class="easyui-combobox" name="searchBy" style="width:80px;">
			<option value="name">职务级别名称</option>
		</select>
