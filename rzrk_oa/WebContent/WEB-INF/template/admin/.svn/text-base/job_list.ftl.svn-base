...
<head lang="en">
    ...
    <script type="text/javascript" src="/rzrk/js/background/job_list.js"></script>
</head>
<body>
	<div class="searchBar">
		<a id="addJob" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'">添加岗位</a>
		<a id="delJobs" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-remove'">批量删除</a>
		&nbsp;&nbsp;&nbsp;&nbsp;
