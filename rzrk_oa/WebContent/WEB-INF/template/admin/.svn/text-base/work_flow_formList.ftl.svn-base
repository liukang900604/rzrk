...
<head lang="en">
    ...
    <script type="text/javascript" src="/rzrk/js/background/workFlowForm_list.js"></script>
...
<body>
	<div class="searchBar">
		<a id="addWorkFlowForm" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'">新增表单</a>
		&nbsp;&nbsp;&nbsp;&nbsp;
