...
<title>添加/编辑导航 - Powered By UNICORN</title>
				...
				<tr>
					...
					<td>
						<select id="systemUrl">
							...
							<option value="<#noparse>${base}</#noparse>/rzrk/leave_message.htm"<#if ("$" + "{base}/rzrk/leave_message.htm" == navigation.url)!> selected</#if>>在线留言</option>
