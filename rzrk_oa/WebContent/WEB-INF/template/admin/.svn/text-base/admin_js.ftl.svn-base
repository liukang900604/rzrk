...
if(typeof(KindEditor) != "undefined") {
	KindEditor.ready(function(K) {
		editor = K.create("#editor", {
			...
			uploadJson: rzrk.base + "/admin/file!ajaxUpload.action",
			fileManagerJson: rzrk.base + "/admin/file!ajaxBrowser.action",
...
function currencyFormat(price) {
	price = setScale(price, rzrk.priceScale, rzrk.priceRoundType);
	return rzrk.currencySign + price + rzrk.currencyUnit;
}
