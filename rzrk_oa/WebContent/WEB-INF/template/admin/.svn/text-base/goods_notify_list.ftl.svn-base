...
<title>到货通知列表 - Powered By UNICORN</title>
		...
		<form id="listForm" action="goods_notify!list.action" method="post">
			...
			<table id="listTable" class="listTable">
				<tr>
					...
					<th>
						<a href="#" class="sort" name="mobile" hidefocus>手机</a>
					</th>
					<th>
				...
				<#list pager.result as goodsNotify>
					...
					<tr>
						<td>
							<input type="checkbox" name="ids" value="${goodsNotify.id}"<#if goodsNotify.isSent> disabled</#if> />
						</td>
						<td>
							<a href="${base}/rzrk/goods!displayDetail.action?id=${product.goods.id}" target="_blank">
								${product.name}
							</a>
						</td>
						<td>
