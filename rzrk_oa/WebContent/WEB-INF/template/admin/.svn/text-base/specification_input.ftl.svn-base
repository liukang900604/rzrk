...
<title>添加/编辑商品规格 - Powered By UNICORN</title>
					...
					<#list (specification.specificationValueList)! as specificationValue>
						<tr class="specificationValueTr">
							...
							<td>
								...
								<#else>
									&nbsp;&nbsp;<img src="${base}/template/rzrk/images/default_specification.gif" style="width: 20px; height: 20px; padding: 1px; vertical-align: middle; border: 1px solid #b2d3f4;" title="无规格图片" />
								</#if>
							</td>
							<td>
