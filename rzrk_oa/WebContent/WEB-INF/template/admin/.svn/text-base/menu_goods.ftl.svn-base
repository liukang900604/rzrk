...
<body class="menu">
	<div class="body">
		...
		<@sec.authorize ifAnyGranted="ROLE_TAG">
			<dl>
				<dt>
					<span>商品标签管理&nbsp;</span>
				</dt>
				<dd>
					<a href="tag!list.action" target="mainFrame">商品标签</a>
				</dd>
				<dd>
					<a href="tag!add.action" target="mainFrame">添加标签</a>
				</dd>
			</dl>
		</@sec.authorize>
        ...
        <@sec.authorize ifAnyGranted="ROLE_BRAND_CIRCLE">
            <dl>
                <dt>
                    <span>品牌圈管理&nbsp;</span>
                </dt>
                <dd>
                    <a href="brand_circle!list.action" target="mainFrame">品牌圈列表</a>
                </dd>
                <dd>
                    <a href="brand_circle!add.action" target="mainFrame">添加品牌圈</a>
                </dd>
            </dl>
        </@sec.authorize>
	</div>
