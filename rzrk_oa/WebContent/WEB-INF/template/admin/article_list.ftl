...
<head lang="en">
    ...
    <script type="text/javascript" src="/rzrk/js/background/article_list.js"></script>
</head>
<body>
	<div class="searchBar">
		<a id="addArticle" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'">添加文章</a>
		<a id="delArticles" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-remove'">批量删除</a>
		&nbsp;&nbsp;&nbsp;&nbsp;
