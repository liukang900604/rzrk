...
<head lang="en">
    ...
    <script type="text/javascript" src="/rzrk/js/background/check_externalRequest_check.js"></script>
	            ...
	            <tbody>
	            	<tr>
	                    ...
	                    <td class="td-right">
                            ...
                            <input type= "hidden" id="workType" name="work.workType" value="5" />
                   ...
                   <fieldset  form="atForm" >
                            ...
                            <table>
                             <tr>
                                ...
                                <td class="td-right">
                                   <input type="text" id="joinProject" name="joinProject" value="" />
                                </td>
                            </tr>
                            </table>
                            <p>
