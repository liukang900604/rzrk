...
<title>品牌列表 - Powered By UNICORN</title>
		...
		<form id="listForm" action="brand!list.action" method="post">
			...
			<table id="listTable" class="listTable">
				<tr>
					...
					<th>
						<a href="#" class="sort" name="pointPlan" hidefocus>是否加入积分计划</a>
					</th>
					<th>
						<a href="#" class="sort" name="vipPoint" hidefocus>VIP所需积分</a>
					</th>
					<th>
				...
				<#list pager.result as brand>
					<tr>
						...
						<td>
							<span class="${brand.isJoinPointPlan?string('true','false')}Icon">&nbsp;</span>
						</td>
						<td>
							${brand.vipPoint}
						</td>
