...
public class PageAction extends BaseAdminAction {
	...
	private String contractCategoryName; //二级分类名称
	private String  idItem;    //父页面id接收
	private String  nameItem; //父页面名称接收
	private String  page;   //父页面窗口或父页面标签
	private String  key; //操作页面返回内容字段
...
//		  }
	 ...
	 public String getDataList() {
		...
		ContractCategory  contractCategory = contractCategoryService.getContractCategoryByCategoryname(contractCategoryName);
		if(contractCategory == null){
			return LIST;
		}
		this.setAttribute("contractCategoryId", contractCategory.getId());
